<?php
    ...
    if(isset($_POST['submit'])) {
        ...
        $update = mysqli_query($db, "UPDATE kumpulan_resep SET nama_masakan='$n_masakan', asal_makanan='$a_masakan', bahan_utama='$b_utama' WHERE id_resep='$id'");
        if($update) {
...
<body>
    ...
    <div class="main">
        <div class="b-resep">
            <h3>Edit Resep</h3>
            <form action="" method="post" class="resep">
                <label for="">Nama Masakan : </label> <br>
                <input type="text" name="n-masakan" class="nama-resep"> <br>

                <label for="">Asal Masakan : </label> <br>
                <input type="text" name="a-masakan" class="asal-resep"> <br>

                <label for="">Bahan Utama : </label> <br>
                <input type="text" name="b-utama" class="bahan-utama"> <br>
